package com.mftplus.appointmentmicro.appointments.config;

import com.mftplus.appointmentmicro.appointments.exception.ExceptionWrapper;
...
//    @Around("@annotation(ExceptionHandlerAndLogger)")
    @Around("execution(* com.mftplus.appointmentmicro.appointments.controller..*.*(..))")
